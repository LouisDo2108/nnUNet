...
class nnUNetTrainerCBAM_50epochs(nnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
...
class nnUNetTrainerSingleModa_50epochs_tuanluc(nnUNetTrainer_50epochs_tuanluc):
    # @staticmethod
    def build_network_architecture(self,
                                   plans_manager: PlansManager,
                                   dataset_json,
        ...
        """
        from nnunetv2.tuanluc_dev.get_network_from_plans import get_network_from_plans_single_moda
        return get_network_from_plans_single_moda(plans_manager, dataset_json, configuration_manager,
                                      num_input_channels, deep_supervision=enable_deep_supervision, 
                                      custom_network_config_path=self.custom_network_config_path)
