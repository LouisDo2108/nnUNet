...
if __name__ == '__main__':
    ...
    #     shutil.copy(join(brats_data_dir_test, c, c + "_t1.nii.gz"), join(imagestr, c + '_0000.nii.gz'))
    #     shutil.copy(join(brats_data_dir_test, c, c + "_t1ce.nii.gz"), join(imagestr, c + '_0001.nii.gz'))
    #     shutil.copy(join(brats_data_dir_test, c, c + "_t2.nii.gz"), join(imagestr, c + '_0002.nii.gz'))
    #     shutil.copy(join(brats_data_dir_test, c, c + "_flair.nii.gz"), join(imagestr, c + '_0003.nii.gz'))
