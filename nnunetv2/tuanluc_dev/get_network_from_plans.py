...
# Extended nnUNet with batch normalization
def get_network_from_plans_bn(plans_manager: PlansManager,
                           dataset_json: dict,
                           configuration_manager: ConfigurationManager,
                           num_input_channels: int,
                           deep_supervision: bool = True,
...
def get_network_from_plans_cbam_everystage(plans_manager: PlansManager,
    ...
    mapping = {
        'PlainConvUNet': CBAMEveryStagePlainConvUNet,
        'ResidualEncoderUNet': ResidualEncoderUNet
    }
    kwargs = {
        'PlainConvUNet': {
